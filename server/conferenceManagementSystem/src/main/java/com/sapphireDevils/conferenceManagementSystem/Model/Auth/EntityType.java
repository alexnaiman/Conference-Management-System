...
public enum EntityType {
     ...
     */
    public abstract UserAllDataDto create(ModelMapper modelMapper, String encodedPassword, UserRegisterDto accountDto, RoleRepository roleRepository, AuthorRepository authorRepository);
}
